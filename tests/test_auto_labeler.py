...
class TestAutoLabelerConfig:
    ...
    def test_default_config(self):
        ...
        from ml_engine.inference import OUTPUT_BOXES_ONLY, AutoLabelerConfig
    ...
    def test_custom_config(self):
        ...
        config = AutoLabelerConfig(box_threshold=0.3, nms_threshold=0.7, device="cpu")
    ...
    def test_output_modes(self):
        ...
        from ml_engine.inference import OUTPUT_BOTH, OUTPUT_BOXES_ONLY, OUTPUT_MASKS_ONLY, AutoLabelerConfig
...
class TestExportToCoco:
        ...
        detections_list = [
            {
                ...
                "class_ids": [],
                "scores": [],
                "image_info": {"file_name": "test.jpg", "width": 640, "height": 480},
            }
        ]
    ...
    def test_export_with_detections_both_mode(self):
        ...
        from ml_engine.inference import OUTPUT_BOTH, COCOExporter
    ...
    def test_export_boxes_only_mode(self):
        ...
        from ml_engine.inference import OUTPUT_BOXES_ONLY, COCOExporter
    ...
    def test_export_masks_only_mode(self):
        ...
        from ml_engine.inference import OUTPUT_MASKS_ONLY, COCOExporter
...
class TestBackwardCompatibility:
    ...
    def test_visualize_functions_exported(self):
        ...
        from ml_engine.inference import visualize_batch, visualize_detections
...
class TestDetectorProtocol:
    ...
    def test_detection_result_empty(self):
        ...
        result = DetectionResult(boxes_xyxy=np.array([]), confidences=np.array([]), class_ids=np.array([]))
    ...
    def test_detection_result_with_data(self):
        ...
        result = DetectionResult(
            boxes_xyxy=np.array([[10, 20, 50, 60]]), confidences=np.array([0.9]), class_ids=np.array([0])
        )
...
@pytest.mark.skipif(
    not Path("data/models/pretrained/groundingdino_swint_ogc.pth").exists()
    or not Path("data/models/pretrained/mobile_sam.pt").exists(),
...
class TestAutoLabelerIntegration:
    ...
    def test_label_single_image(self):
        ...
        results = labeler.label_images(image_paths=[image_path], class_prompts=["dog"])
    ...
    def test_label_images_with_export(self):
        ...
        # Use demo images
        image_paths = ["assets/demo2.jpg", "assets/demo3.jpg"]
