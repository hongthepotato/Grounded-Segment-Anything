"""Unit tests for platform/launch_engine.py.
...
def engine(monkeypatch):
    import platform.launch_engine as eng
...
SAMPLE_BLOCKS = [
    {
        ...
        "category": "sensor", "requires_gpu": False,
        "ports": {"output": [{"id": "image_out", "alias": "image_frame", "ros2_type": "sensor_msgs/Image", "label": "Camera"}]},
    },
    {
        "id": "yolo-inference", "version": "1.0.0", "display_name": "YOLO",
        "category": "detection", "requires_gpu": True,
        "ports": {
            "input": [{"id": "image_in", "alias": "image_frame", "ros2_type": "sensor_msgs/Image", "label": "Camera Input"}],
            "output": [{"id": "detections_out", "alias": "detections", "ros2_type": "vision_msgs/Detection2DArray", "label": "Detections"}],
        },
    },
]
...
SAMPLE_GRAPH = {
    "nodes": [
        ...
        {"node_id": "node-yolo-1", "block_id": "yolo-inference", "block_version": "1.0.0", "params": {"confidence": 0.5}},
    ],
    "edges": [
        {"edge_id": "e1", "source_node_id": "node-cam-1", "source_port_id": "image_out",
         "target_node_id": "node-yolo-1", "target_port_id": "image_in"},
    ],
}
...
class TestBuildRemapArgs:
    def test_source_node_gets_remap_for_output_port(self, engine):
        graph = {
            ...
            "edges": [{"edge_id": "e1", "source_node_id": "n1", "source_port_id": "image_out",
                       "target_node_id": "n2", "target_port_id": "image_in"}],
        }
    ...
    def test_unrelated_node_gets_empty_args(self, engine):
        graph = {
            "edges": [{"edge_id": "e1", "source_node_id": "n1", "source_port_id": "p_out",
                       "target_node_id": "n2", "target_port_id": "p_in"}],
        }
    ...
    def test_multiple_edges_generate_multiple_remaps(self, engine):
        graph = {
            "edges": [
                {"edge_id": "e1", "source_node_id": "n1", "source_port_id": "out1",
                 "target_node_id": "n2", "target_port_id": "in1"},
                {"edge_id": "e2", "source_node_id": "n1", "source_port_id": "out2",
                 "target_node_id": "n3", "target_port_id": "in1"},
            ],
        }
