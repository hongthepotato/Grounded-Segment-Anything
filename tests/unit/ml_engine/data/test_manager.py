...
class TestDataManagerFromFile:
    ...
    def test_from_file_success(self, mock_transform, temp_data_environment):
        ...
        manager = DataManager.from_file(data_path=data["coco_path"], image_paths=data["image_paths"])
    ...
    def test_from_file_nonexistent_raises(self):
        ...
        with pytest.raises(FileNotFoundError):
            DataManager.from_file(data_path="/nonexistent/path.json", image_paths=["img1.jpg"])
    ...
    def test_from_file_invalid_coco_raises(self, mock_transform, temp_data_environment):
        ...
        with pytest.raises(ValueError):
            DataManager.from_file(data_path=str(invalid_path), image_paths=data["image_paths"])
