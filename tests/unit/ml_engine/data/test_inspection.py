...
class TestInspectDataset:
    ...
    def test_returns_expected_keys(self, valid_coco_data_combined):
        ...
        expected_keys = [
            ...
            'category_id_to_index', 'index_to_category_id',
            'num_images', 'num_annotations', 'annotation_mode', 'class_counts'
        ]
...
class TestInspectDatasetEdgeCases:
    ...
    def test_large_category_ids(self):
        ...
        data = {
            ...
            'categories': [
                {'id': 9999, 'name': 'class_a'},
                {'id': 123456, 'name': 'class_b'}
            ]
        }
    ...
    def test_single_image_no_annotations(self):
        ...
        data = {
            'images': [
                {'id': 0, 'file_name': 'img.jpg', 'width': 100, 'height': 100}
            ],
            'annotations': [],
            'categories': [{'id': 0, 'name': 'cat'}]
        }
