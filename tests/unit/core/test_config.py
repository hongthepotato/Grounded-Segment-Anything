...
from core.config import load_config, load_json, merge_configs, save_config, save_json
...
class TestSaveConfig:
    ...
    def test_save_config_creates_file(self, temp_dir):
        ...
        config = {"learning_rate": 1e-4, "batch_size": 8, "lora": {"r": 16, "alpha": 32}}
...
class TestMergeConfigs:
    ...
    def test_merge_nested_configs(self):
        ...
        base = {"a": 1, "lora": {"r": 16, "alpha": 32, "dropout": 0.1}}
        override = {
            "lora": {
                "r": 32,  # Override
                "beta": 64,  # New key
