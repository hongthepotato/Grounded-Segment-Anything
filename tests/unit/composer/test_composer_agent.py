"""Unit tests for composer/composer_agent.py.
...
BLOCKS_CATALOG = [
    ...
    },
    {
        ...
        "ports": {
            "input": [
                {"id": "image_in", "alias": "image_frame", "ros2_type": "sensor_msgs/Image", "label": "Input"}
            ],
            "output": [
                {
                    "id": "detections_out",
    ...
    },
    {
        ...
        "ports": {
            ...
            "output": [
                {"id": "flag_out", "alias": "flag_event", "ros2_type": "std_msgs/Bool", "label": "Flag"}
            ],
        },
    },
]
...
def agent(monkeypatch):
    import composer.composer_agent as ca
...
class TestExecuteTool:
    ...
    def test_get_block_details_returns_error_for_unknown(self, agent):
        ...
        result = agent._execute_tool(
            "get_block_details", {"block_id": "nonexistent"}, session, BLOCKS_CATALOG
        )
    ...
    def test_validate_connection_compatible_aliases(self, agent):
        ...
        result = agent._execute_tool(
            "validate_connection",
            {
                "source_block_id": "usb-camera",
                "source_port_id": "image_out",
                "target_block_id": "yolo-inference",
    ...
    def test_validate_connection_incompatible_aliases(self, agent):
        ...
        result = agent._execute_tool(
            "validate_connection",
            {
                "source_block_id": "yolo-inference",
                "source_port_id": "annotated_out",
                "target_block_id": "yolo-inference",
                "target_port_id": "image_in",
            },
            session,
    ...
    def test_validate_connection_detections_to_defect(self, agent):
        ...
        result = agent._execute_tool(
            ...
            {
                "source_block_id": "yolo-inference",
                "source_port_id": "detections_out",
                "target_block_id": "defect-flagging",
                "target_port_id": "detections_in",
            },
            session,
            BLOCKS_CATALOG,
        )
    ...
    def test_add_block_creates_node_in_graph(self, agent):
        _, session = make_session(agent)
        result = agent._execute_tool(
            "add_block", {"block_id": "usb-camera", "params": {"fps": 30}}, session, BLOCKS_CATALOG
        )
    ...
    def test_connect_creates_edge_when_valid(self, agent):
        ...
        r1 = agent._execute_tool(
            "add_block", {"block_id": "usb-camera", "params": {}}, session, BLOCKS_CATALOG
        )
        r2 = agent._execute_tool(
            "add_block", {"block_id": "yolo-inference", "params": {}}, session, BLOCKS_CATALOG
        )
        cam_id = r1["node_id"]
        yolo_id = r2["node_id"]
        result = agent._execute_tool(
            "connect",
            {
                "source_node_id": cam_id,
                "source_port_id": "image_out",
                "target_node_id": yolo_id,
                "target_port_id": "image_in",
            },
            session,
            BLOCKS_CATALOG,
    ...
    def test_connect_fails_for_incompatible_aliases(self, agent):
        ...
        r2 = agent._execute_tool(
            "add_block", {"block_id": "defect-flagging", "params": {}}, session, BLOCKS_CATALOG
        )
        result = agent._execute_tool(
            "connect",
            {
                "source_node_id": r1["node_id"],
                "source_port_id": "image_out",
                "target_node_id": r2["node_id"],
                "target_port_id": "detections_in",
            },
            session,
            BLOCKS_CATALOG,
